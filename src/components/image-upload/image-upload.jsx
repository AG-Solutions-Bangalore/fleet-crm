  ...
  return (
    <div className={`${className}`}>
      ...
      {selectedFile || previewImage ? (
        <div className="relative mt-2 group rounded-lg border border-gray-200 overflow-hidden bg-gray-50 hover:border-gray-300 transition-all">
        ...
        <label
          htmlFor={id}
          className="block mt-2 border-2 border-dashed border-gray-300 rounded-lg p-3 text-center cursor-pointer hover:border-blue-500 hover:bg-blue-50/50 transition-all"
        >
          <Input
            id={id}
            name={id}
